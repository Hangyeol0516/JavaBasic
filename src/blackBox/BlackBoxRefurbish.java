...
public class BlackBoxRefurbish {
    ...
    static int counter = 0; // 시리얼 번호를 생성해주는 역할 (처음엔 0이었다가 ++ 연산자를 통해서 값 증가)
    ...
    public BlackBoxRefurbish() {
        ...
        System.out.println("새로운 시리얼넘버를 발급받았습니다 : " + serialNumber);
    }
    BlackBoxRefurbish(String modelName, String resolution, int price) {
        this(modelName, resolution, price, "블랙");
    }
    BlackBoxRefurbish(String modelName, String resolution, int price, String color) {
        this(); // 기본 생성자 호출
